...
[default]
main   =   host:localhost,user:root,database:smpss,password:liziqiang,charset:utf8
query  =   host:localhost,user:root,database:smpss,password:liziqiang,charset:utf8set:utf8